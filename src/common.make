...
LDFLAGS = -fopenmp -Wl,--no-undefined
endif
...
CFLAGS += -mkl
LDFLAGS += -mkl
LIBS    = -L$(H2PACK_INSTALL_DIR)/lib -lH2Pack -L$(SIMINT_INSTALL_DIR)/lib64 -lsimint -lm
endif

ifeq ($(strip $(USE_OPENBLAS)), 1)
DEFS   += -DUSE_OPENBLAS
INCS   += -I$(OPENBLAS_INSTALL_DIR)/include
LIBS    = -L$(H2PACK_INSTALL_DIR)/lib -Wl,-rpath=$(H2PACK_INSTALL_DIR)/lib  -lH2Pack \
	-L$(SIMINT_INSTALL_DIR)/lib64 -lsimint -L$(OPENBLAS_INSTALL_DIR)/lib -lopenblas -lm
endif
