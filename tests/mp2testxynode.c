...
int main(int argc, char **argv)
{
    ...
    for(int quad = 0;quad<n;quad++)
    {
        ...
        CSRmat_p gdls;
        CSRmat_init(&gdls,nbfp,nbf*nbf);
            
        //printf("now do y index transformation\n");
        Yindextransform5(nbf,gdle,csrdc,gdls,thres3);
        et1 = get_wtime_sec();
        ...
        s1s5xy = calc_S1S51_node(gdls,h2eri, Urbasis,S51cbasisy, nodepairs, nodepairidx);
        et1 = get_wtime_sec();
        calcs51 += et1-st1;
