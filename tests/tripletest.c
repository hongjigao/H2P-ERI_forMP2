...
int main(int argc, char **argv)
{
    ...
    {   
        ...
        st0 = get_wtime_sec();
        TinyDFT_build_energyweightedDDC(TinyDFT, TinyDFT->Cocc_mat,TinyDFT->Cvir_mat,TinyDFT->orbitenergy_array,TinyDFT->D_mat,TinyDFT->DC_mat,Fermie,point[i]);
        et0 = get_wtime_sec();
    ...
    //    printf("The energy is %f\n",energy);
        ...
        printf("The %dth energy in point %f is %f\n",i,point[i],energy);
        totalenergy+=energy;
