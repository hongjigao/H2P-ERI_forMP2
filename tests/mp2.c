...
int main(int argc, char **argv)
{
    ...
    printf("The LOMO is %.16g\n",TinyDFT->orbitenergy_array[0]);
    printf("The HOMO is %.16g\n",TinyDFT->orbitenergy_array[TinyDFT->n_occ-1]);
    printf("The LUMO is %.16g\n",TinyDFT->orbitenergy_array[TinyDFT->n_occ]);
    printf("The HUMO is %.16g\n",TinyDFT->orbitenergy_array[TinyDFT->nbf-1]);
